...
if [[ $name == $cekname ]]; then
    ...
    echo ""
	echo "    Silhakan cek ${green}memberwg${plain}"
	echo ""
	echo ""
echo "----------------------------------------------------"
...
echo ""
	...
	sleep 2
	echo ""
	echo "  Sedang membuat user ${red}${name}${plain}, harap tunggu..."
	sleep 2
	echo ""
...
cekuser="/var/www/html/wg/${cek}del.sh"
  if [[ -f "$cekuser" ]]; then
    ...
    sleep 2
    echo ""
    echo "     User ${red}${cek}${plain} berhasil dihapus..."
    echo ""
	echo ""
echo "----------------------------------------------------"
echo "           Terimakasih sudah menggunakan-"
...
echo ""
    ...
    echo "     Silahkan cek ${green}memberwg${plain}..."
    echo ""
	echo ""
echo "----------------------------------------------------"
echo "           Terimakasih sudah menggunakan-"
